        ...
        {card.length > 0 ? (
          ...
          <div className="w-full h-full p-[40px] col-span-3 flex justify-center items-center flex-col">
            <h1 className="flex justify-center items-center gap-2">
              <BiSolidErrorCircle />
              No Bookmark Blogs Created
            </h1>
            <p className="text-gray-600">
              It looks like there are no bookmark blogs available at the moment.
              Please check back later or create a new blog to get started!
            </p>
          </div>
        )}
        {/* Card Stying */}
