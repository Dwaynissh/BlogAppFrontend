    ...
    <div>
      <div className="w-full py-[15px] ">
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "w-full pl-2 mb-2 py-2 flex justify-start items-center gap-3 cursor-pointer text-[19px] font-semibold transition-all duration-[350ms] bg-white rounded-l-md text-[purple]"
