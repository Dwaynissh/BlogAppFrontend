        ...
        <AnimatePresence>
          {menu ? (
            <motion.div
              ...
              className={`absolute 
                top-[80px]
               right-0 left-0 h-[55px] bg-white flex justify-center rounded-b-lg shadow-sm ${
                 menu ? "" : "opacity-0"
               }`}
            >
              <div className="w-[92%] flex items-center justify-between transition-all duration-300">
                ...
                <div className="sm:hidden flex items-center justify-end gap-[15px]">
